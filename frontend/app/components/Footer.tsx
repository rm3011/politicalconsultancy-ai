...
// SVG Social Icons - Memoized to prevent unnecessary re-renders
...
const quickLinks = [
  ...
  // Removed: { name: 'S-AI', href: '/s-ai' } - route doesn't exist
  // Removed: { name: 'Contact', href: '/contact' } - now on homepage
];
  ...
  return (
    <footer className="relative bg-[#020202] border-t border-red-500/10 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        ...
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1/2 h-32 bg-red-500/2 blur-3xl" />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="py-12 md:py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed mb-6 max-w-xs font-light tracking-wide">
              AI-powered political intelligence and campaign analytics platform for modern
              political campaigns.
            </p>
        ...
        <div className="border-t border-red-500/10 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-zinc-500 text-center md:text-left tracking-wide">
            &copy; {new Date().getFullYear()} NEVAS Technologies Pvt Ltd. All rights
            reserved.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6 text-xs">
            <Link
              href="#"
              className="text-zinc-500 hover:text-zinc-400 transition-colors duration-300 tracking-wide"
            >
              Privacy Policy
            </Link>
