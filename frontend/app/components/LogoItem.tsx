    ...
    return (
      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-linear-to-tr from-red-500/5 via-transparent to-red-500/5" />
        </div>
