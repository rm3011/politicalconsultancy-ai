...
export const LogoLoop = React.memo<LogoLoopProps>(({
  ...
  const isNodeItem = (item: LogoItem): item is { node: React.ReactNode; href?: string; title?: string; ariaLabel?: string } => {
    return 'node' in item;
  };

  const isImageItem = (item: LogoItem): item is { src: string; alt?: string; href?: string; title?: string; srcSet?: string; sizes?: string; width?: number; height?: number } => {
    return 'src' in item;
  };
