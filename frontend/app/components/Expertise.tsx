      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="text-center mb-12 md:mb-16">
            ...
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-white leading-[1.1] tracking-tight">
              ...
              <span className="relative">
                ...
                <span
                  className="absolute -bottom-2 left-0 w-full h-0.5 bg-linear-to-r from-transparent via-red-500/50 to-transparent"
                  aria-hidden="true"
                />
              </span>
            </h3>
          ...
          <div className="relative">
            ...
            <div
              className="absolute left-0 top-0 bottom-0 w-16 md:w-32 bg-linear-to-r from-[#020202] to-transparent z-10 pointer-events-none"
              aria-hidden="true"
            />
            <div
              className="absolute right-0 top-0 bottom-0 w-16 md:w-32 bg-linear-to-l from-[#020202] to-transparent z-10 pointer-events-none"
              aria-hidden="true"
            />
          ...
          >
            <span className="inline-flex items-center gap-2">
              ...
              {POLITICAL_PARTIES?.length || 0}+ political parties across the political
              spectrum
              <span className="w-1 h-1 rounded-full bg-red-500/30" aria-hidden="true" />
            </span>
          </motion.p>
